			...
			<div class="complaint status">
				<div class="input-box">
					<span class="details">Id Number</span> <input type="text"
						name="idnumber" id="idnumber" placeholder="Enter your ID">
				</div><br><br>

				<div class="input-box">
					<span class="details">Full Name</span> <input type="text" name="fullname"
				...
				type="radio" name="gender" id="gender"> <input type="radio"
				name="gender" id="gender"><br><br>
				...
				<div class="input-box">
					<span class="details">Phone Number</span> <input type="text"
						name="phone" id="phone" placeholder="Enter your number">
				</div>
				...
				<div class="input-box">
					<span class="details">Occupation</span> <input type="occupation"
						name="occupation" id="occupation" placeholder="Enter your occupation">
				</div>
				<div class="input-box">
					<span class="details">Complaint</span> <input
						type="complaint" name="complaint" id="complaint"
